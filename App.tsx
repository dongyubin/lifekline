...
<body class="bg-gray-50 min-h-screen p-4 md:p-12">
  ...
  const handleLoadDemo = async () => {
    try {
      ...
      const demoResult: LifeDestinyResult = {
        chartData: demoData.chartPoints,
        analysis: {
          bazi: demoData.bazi || [],
          summary: demoData.summary || "无摘要",
          summaryScore: demoData.summaryScore || 5,
          personality: demoData.personality || "无性格分析",
          personalityScore: demoData.personalityScore || 5,
          industry: demoData.industry || "无",
          industryScore: demoData.industryScore || 5,
          fengShui: demoData.fengShui || "建议多亲近自然",
          fengShuiScore: demoData.fengShuiScore || 5,
          wealth: demoData.wealth || "无",
          wealthScore: demoData.wealthScore || 5,
          marriage: demoData.marriage || "无",
          marriageScore: demoData.marriageScore || 5,
          health: demoData.health || "无",
          healthScore: demoData.healthScore || 5,
          family: demoData.family || "无",
          familyScore: demoData.familyScore || 5,
          crypto: demoData.crypto || "暂无交易分析",
          cryptoScore: demoData.cryptoScore || 5,
          cryptoYear: demoData.cryptoYear || "待定",
          cryptoStyle: demoData.cryptoStyle || "现货定投",
        },
      };
      setResult(demoResult);
      setError(null);
    } catch (err: any) {
      setError(`示例数据加载失败：${err.message}`);
    }
  };
        ...
        {!result && (
          <div className="flex flex-col items-center justify-center min-h-[60vh] gap-8 animate-fade-in">
            ...
            <button
              ...
              className="mt-6 px-6 py-3 bg-indigo-600 text-white rounded-xl hover:bg-indigo-700 transition-all font-medium flex items-center gap-2"
            >
